...
export default function Home() {
  ...
  return (
    <div className="app-shell">
        ...
        <div className="header-inner">
          ...
          <div className="header-actions">
            <nav className="header-nav-links" aria-label="Main navigation">
              <a href="#workspace" className="header-nav-link">
                Converter
              </a>
              <button
                type="button"
              ...
              <a href="#faqs" className="header-nav-link">
                FAQs
              </a>
      ...
      <main className="main">
        <section className="hero">
          <div className="eyebrow">
            <span /> YOUR EVERYDAY DOCUMENT WORKSPACE
          </div>
          <h1>
            New format.<br className="mobile-break" /> Same attention to detail.
          </h1>
          <p>
            Convert documents, images and presentations.<br className="desktop-break" /> Thoughtful controls. Clear results.
            All in one place.
          </p>
        </section>
      ...
      <StickyMobileCta onUploadClick={handleMobileUploadClick} isBusy={busy} />
